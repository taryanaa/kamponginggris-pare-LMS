...
class IeltsB1Results extends Model
{
    use HasFactory;

    protected $table = 'ielts_b1_results';
    ...
    protected $casts = [
        ...
        'speaking_ielts' => 'decimal:1',
        'speaking_fluency' => 'decimal:1',
        'speaking_pronunciation' => 'decimal:1',
        'speaking_grammar' => 'decimal:1',
